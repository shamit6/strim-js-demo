...
const {takeUntil, mapTo} = require('rxjs/operators')
...
module.exports = {
  ...
  getPlayersDistances,
  getPlayersTurnovers,
  calcScore: function({distance: distanceWeight, turnovers: turnoversWeight}, {players, distances, turnovers}) {
    const wheightedScores = {}

    players.forEach(player => {
      wheightedScores[player] = distances[player] * distanceWeight + turnovers[player] * turnoversWeight
    })
